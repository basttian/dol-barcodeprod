...
/**
 * \file    test/phpunit/BarcodeprodFunctionalTest.php
 * \ingroup barcodeprod
...
/**
 * Class BarcodeprodFunctionalTest
 *
 ...
 *
 * @package Testbarcodeprod
 */
class BarcodeprodFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBarcodeprod')->click();
		} else {
			// Disable the module
			$this->byHref('modBarcodeprod')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/barcodeprod/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('barcodeprod/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/barcodeprod/admin/about.php');
		$this->authenticate();
		return $this->assertContains('barcodeprod/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('barcodeprodwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBarcodeprod_BarcodeprodTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBarcodeprod_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
